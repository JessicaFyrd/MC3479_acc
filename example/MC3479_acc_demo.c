...
int main(void)
{
  ...
  //Variables
  OFFSET_XYZ_TypeDef offsets;
  GAINS_XYZ_TypeDef gains;
  ACC_XYZ_TypeDef acc;
  ACC_XYZ_g_TypeDef acc_g;

  //Initialization
  ACC_MC3479_init(hi2c2);
  ...
  ACC_MC3479_set_range(MC3479_RANGE_4G);
  //ACC_MC3479_set_filter(MC3479_FILTER_IDR_DIV_12);
